            ...
            [
                [
                    InlineKeyboardButton(
                        "➕ Tambahkan Bae Robot Ke Grup Anda ➕", url=f"https://t.me/{BOT_USERNAME}?startgroup=true")],
                [
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "🎁 Donate", url=f"https://t.me/Reeeeeezy")
                ]
            ]
        ),
...
def map(pos):
    if(pos==1):
        ...
        button = [
            [InlineKeyboardButton("➕ Tambahkan Bae Robot Ke Grup Anda ➕", url=f"https://t.me/{BOT_USERNAME}?startgroup=true")],
            ...
            [InlineKeyboardButton(text = 'Instagram', url=f"https://www.instagram.com/ridhoalfahrezi._")],
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "Panduan Bae Robot", url="https://t.me/BaeChannels/2"
                    )
                ]
            ]
        ),
...
async def reload(client: Client, message: Message):
    await message.reply_text("""Bae Robot **Berhasil Dimulai Ulang!**\n\n• **Daftar Admin** Telah **Diperbarui**""",
      reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "Created By", url=f"https://t.me/Reeeeeezy"
                    )
                ]
            ]
        )
